...
| **Stakeholder context** | New name, role, responsibility, opinion, or relationship mentioned | "Alice is actually the one who owns that decision, not Bob" |
...
- "I mentioned Alice owns that" — stakeholder context shared but lost
